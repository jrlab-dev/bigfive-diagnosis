...
function renderGate(featureId) {
  ...
  gate.innerHTML =
    ...
    + '<p style="color:' + c.muted + ';font-size:0.8rem;margin:0 0 4px 0;line-height:1.6;">・ビッグファイブ診断を受ける（自分・あの人どちらでも1枚）</p>'
    + '<p style="color:' + c.muted + ';font-size:0.8rem;margin:0;line-height:1.6;">・友達から診断結果をシェアしてもらう（1枚）</p>'
    + '</div>'
    + '</div>'
